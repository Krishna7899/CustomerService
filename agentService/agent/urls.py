...
urlpatterns=[
    ...
    path('createPartner/', views.partnerCreate, name="createPartner"),
    path('partnerSearch/', views.partnerSearch, name="partnerSearch"),
    path('partnerUpdate/', views.partnerUpdate, name="partnerUpdate"),
